...
COMMISSIONING_KEYWORDS_PRIMARY = [
    ...
    "ASHRAE Commissioning Professional",
    "MEP commissioning",
...
COMMISSIONING_KEYWORDS_TERTIARY = [
    ...
    "boiler plant",
    "plant chillers",
    "replace heating plant chillers",
    "controls upgrade",
    "2021 IECC",
    ...
    "building systems engineering services",
...
DIRECT_SCRAPE_STATES = [
    ...
    {
        "name": "SUNY SUCF Construction Bid Calendar",
        "url": "https://sucf.suny.edu/sites/default/files/docs/BidCalendar.pdf",
        "state": "NY",
        "type": "suny_sucf_bid_calendar_pdf",
        "js_render": False,
        "active": True,
        "notes": "State University Construction Fund construction bid calendar PDF. Dedicated parser extracts campus, project number, title, advertised date, and bid date.",
    },
    {
    ...
    {
        "name": "Colchester VT Bid Postings",
        "url": "https://colchestervt.gov/Bids.aspx",
        "state": "VT",
        "type": "civicengage_bids",
        "active": True,
        "notes": "Town of Colchester CivicEngage bid postings page. Reusable parser extracts open bidID detail links.",
    },
    {
        "name": "Essex VT Bid Postings",
        "url": "https://www.essexvt.gov/Bids.aspx",
        "state": "VT",
        "type": "civicengage_bids",
        "active": True,
        "notes": "Town of Essex CivicEngage bid postings page. Reusable parser extracts open bidID detail links.",
    },
    {
        "name": "Montpelier VT Bid Postings",
        "url": "https://www.montpelier-vt.org/Bids.aspx",
        "state": "VT",
        "type": "civicengage_bids",
        "active": True,
        "notes": "City of Montpelier CivicEngage bid postings page. Reusable parser dedupes repeated category links by bidID.",
    },
    {
        "name": "South Burlington VT Bid Postings",
        "url": "https://www.southburlingtonvt.gov/bids.aspx",
        "state": "VT",
        "type": "civicengage_bids",
        "active": True,
        "notes": "City of South Burlington CivicEngage bid postings page. Included even when no open bidID links are currently listed.",
    },
    {
        "name": "Fairfax VT RFPs",
        "url": "https://www.fairfax-vt.gov/bids/",
        "state": "VT",
        "type": "fairfax_vt_bids",
        "active": True,
        "notes": "Town of Fairfax RFP/bid table with direct PDF/DOCX links and closing dates.",
    },
    {
        "name": "Essex Junction VT Invitation to Bid",
        "url": "https://www.essexjunction.org/news/invitation-to-bid",
        "state": "VT",
        "type": "municipal_document_links",
        "active": True,
        "notes": "City of Essex Junction invitation-to-bid/RFP page with direct PDF links.",
    },
    {
        "name": "Woodstock VT Request for Proposals",
        "url": "https://www.townofwoodstock.org/departments/request-for-proposals",
        "state": "VT",
        "type": "municipal_document_links",
        "active": True,
        "notes": "Town of Woodstock request-for-proposals page with direct PDF links.",
    },
    {
        "name": "Rutland VT Bids and RFPs",
        "url": "https://www.rutlandcity.org/departments/clerks-office/bids-requests-for-proposals-rfps/",
        "state": "VT",
        "type": "municipal_document_links",
        "active": True,
        "notes": "City of Rutland bids/RFP page with direct PDF links. Parser skips addenda/supporting bid sheets.",
    },
    {
        "name": "Shelburne VT Bids RFQs and RFPs",
        "url": "https://www.shelburnevt.org/398/Bids-RFQs-RFPs",
        "state": "VT",
        "type": "municipal_document_links",
        "active": True,
        "notes": "Town of Shelburne RFP/RFQ page with DocumentCenter links. Parser skips bid results/contracts.",
    },
    {
        "name": "Saranac Lake NY Bids RFPs RFQs",
        "url": "https://saranaclakeny.gov/bids-rfps-rfqs/",
        "state": "NY",
        "type": "municipal_document_links",
        "active": True,
        "notes": "Village of Saranac Lake procurement page with direct RFQ/RFP packet links.",
    },
    {
